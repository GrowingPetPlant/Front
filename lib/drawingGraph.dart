...
class GraphInfo {
  ...
  GraphInfo(
      {required this.humiDawn,
      required this.humiDay,
      required this.humiMorning,
      required this.humiNight,
      required this.moistureDawn,
      required this.moistureDay,
      required this.moistureMorning,
      required this.moistureNight,
      required this.tempDawn,
