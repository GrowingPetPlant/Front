...
class _CalendarState extends State<calender> {
        ...
        child: Container(
          ...
          child: Padding(
            padding: EdgeInsets.symmetric(
                vertical: screenHeight * 0.04, horizontal: horizontalPadding),
  ...
  void getGraphInfo() async {
    ...
    setState(() {
      list_Humi = [
        graphInfo.humiDawn,
        graphInfo.humiMorning,
        graphInfo.humiDay,
        graphInfo.humiNight
      ];
      list_Moisture = [
        graphInfo.moistureDawn,
        graphInfo.moistureMorning,
        graphInfo.moistureDay,
        graphInfo.moistureNight
      ];
      list_Temp = [
        graphInfo.tempDawn,
        graphInfo.tempMorning,
        graphInfo.tempDay,
        graphInfo.tempNight
      ];
    });
