...
class home extends State<Home> with WidgetsBindingObserver {
  ...
  void _putWater() async {
    ...
    List<DateTime>? wateringDate = await fetchWarteringDates(
    ...
    if (!wateringDate!.isEmpty) {
      ...
      waterDialog(context, PostWateringReq(plantNumber: userPlant!.plantNumber,
        wateringDate: iso8601String_today));
    }
    //온도
    ...
    return Dialog(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(ifWatered!, textAlign: TextAlign.center,
                ...
                children: [
                  TextButton(
                      ...
                      child: const Text("확인", style: TextStyle(
                          fontSize: 16, color: Color(0xff81ae17)),
                      )
                  ),
                  TextButton(
                      onPressed: () {
